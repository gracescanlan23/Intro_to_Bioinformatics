...
### Count significant DEGs
```{r}
tubular_num_sig <- sum(res_df$padj < 0.05, na.rm = TRUE)
tubular_up_genes <- sum(res_df$padj < 0.05 & res_df$log2FoldChange > 0, na.rm = TRUE)
tubular_down_genes <- sum(res_df$padj < 0.05 & res_df$log2FoldChange < 0, na.rm = TRUE)
```
### Volcano plot
```{r}
...
### Count significant DEGs
```{r}
early_num_sig <- sum(res_df$padj < 0.05, na.rm = TRUE)
early_up_genes <- sum(res_df$padj < 0.05 & res_df$log2FoldChange > 0, na.rm = TRUE)
early_down_genes <- sum(res_df$padj < 0.05 & res_df$log2FoldChange < 0, na.rm = TRUE)
```
### Volcano plot
```{r}
...
print(volcano_plot_early_stage)
```
### MA plot
```{r}
